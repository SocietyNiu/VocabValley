...
进入塔内，你将在左上角看到你的知识碎片，获取和使用方式参考后续。

巴别塔左下部的书架负责词库选择，你可以点击书架选择预置词库或自定义词库。
![](Docs/Screenshots/Vocab.png)

巴别塔上侧的桌子负责错题管理，你可以点击桌子上的书本打开错题库。错题库需要10个知识碎片解锁。
![](Docs/Screenshots/WrongWords.png)

巴别塔右下侧的入口是地下室，需要100个知识碎片解锁。
...
普通楼层存在单词石碑，石碑上有若干问题，你必须选择正确所有的选项才能通过该层。注意：如果你在回答问题时选择了错误的选项，那么该题将会被重新加入问题集尾部并需要你重新回答。每次正确回答会给玩家1个知识碎片。

**你可以使用1-4选择选项并使用回车或空格进入下一题**
